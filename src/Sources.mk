...
COMMON_SOURCES = fmbt.cc test_engine.cc log.cc helper.cc lts.g.d_parser.cc xrules.g.d_parser.cc lts_xrules.cc  $(LOCAL_ADAPTERS) $(LOCAL_HEURISTICS) $(LOCAL_COVERAGES) $(LOCAL_MODELS) conf.g.d_parser.cc conf.cc mrules.g.d_parser.cc policy.cc alg_bdfs.cc history.cc end_condition.cc null.cc aal.cc endhook.cc coverage_of.cc  random.cc random_c.cc random_devrandom.cc random_supported.cc function.cc function_pid.cc function_const.cc function_time.cc function_ftime.cc function_sum.cc params.cc heuristic_proxy.cc coverage_proxy.cc
