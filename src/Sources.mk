...
remote_adapter_loader_SOURCES = remote_adapter_loader.cc adapter.cc log.cc adapter_dummy.cc adapter_model.cc adapter_v4l2.cc helper.cc model.cc random.cc random_proxy.cc function.cc random_c.cc params.cc
...
fmbt_log2lsts_SOURCES = log2lsts.cc lts.cc model.cc log.cc coverage.cc coverage_proxy.cc lts.g.d_parser.cc history.cc helper.cc history_log.cc model_yes.cc params.cc
