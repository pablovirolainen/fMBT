...
LOCAL_HEURISTICS =  heuristic.cc heuristic_random.cc heuristic_mrandom.cc heuristic_greedy.cc weight.g.d_parser.cc heuristic_weight.cc heuristic_include.cc heuristic_coverage_random.cc coverage_random.cc heuristic_multichild.cc heuristic_cselect.cc
...
remote_adapter_loader_SOURCES = remote_adapter_loader.cc adapter.cc log.cc adapter_dummy.cc adapter_model.cc adapter_v4l2.cc helper.cc model.cc random.cc function.cc random_c.cc params.cc alphabet.cc function_const.cc function_array.cc

fmbt_aalp_SOURCES = aalp.ll helper.cc params.cc log.cc

fmbt_log2lsts_SOURCES = log2lsts.cc lts.cc model.cc log.cc coverage.cc lts.g.d_parser.cc history.cc helper.cc history_log.cc model_yes.cc params.cc adapter.cc alphabet.cc
